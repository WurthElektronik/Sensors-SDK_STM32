...
/**
 * @file
 * @brief Header file for WSEN_ITDS activity/inactivity example.
 *
...
#ifndef WSEN_ITDS_ACTIVITY_INACTIVITY_EXAMPLE_H_INCLUDED
#define WSEN_ITDS_ACTIVITY_INACTIVITY_EXAMPLE_H_INCLUDED

void WE_itdsActivityInactivityExampleInit();
void WE_itdsActivityInactivityExampleLoop();

#endif /* WSEN_ITDS_ACTIVITY_INACTIVITY_EXAMPLE_H_INCLUDED */
