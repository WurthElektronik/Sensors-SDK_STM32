...
/**
 * @file
 * @brief Header file for WSEN_ITDS FIFO example.
 *
...
#ifndef WSEN_ITDS_FIFO_EXAMPLE_H_INCLUDED
#define WSEN_ITDS_FIFO_EXAMPLE_H_INCLUDED

void WE_itdsFifoExampleInit();
void WE_itdsFifoExampleLoop();

#endif /* WSEN_ITDS_FIFO_EXAMPLE_H_INCLUDED */
