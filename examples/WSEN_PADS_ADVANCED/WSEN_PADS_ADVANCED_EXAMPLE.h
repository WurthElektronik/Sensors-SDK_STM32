...
/**
 * @file
 * @brief Header file for WSEN-PADS advanced usage example.
 *
...
#ifndef WSEN_PADS_ADVANCED_EXAMPLE_H_INCLUDED
#define WSEN_PADS_ADVANCED_EXAMPLE_H_INCLUDED

void WE_padsAdvancedExampleInit();
void WE_padsAdvancedExampleLoop();

#endif /* WSEN_PADS_ADVANCED_EXAMPLE_H_INCLUDED */
