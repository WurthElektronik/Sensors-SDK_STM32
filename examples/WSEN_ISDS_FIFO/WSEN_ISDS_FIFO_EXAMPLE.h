...
/**
 * @file
 * @brief Header file for WSEN_ISDS FIFO example.
 *
...
#ifndef WSEN_ISDS_FIFO_EXAMPLE_H_INCLUDED
#define WSEN_ISDS_FIFO_EXAMPLE_H_INCLUDED

void WE_isdsFifoExampleInit();
void WE_isdsFifoExampleLoop();

#endif /* WSEN_ISDS_FIFO_EXAMPLE_H_INCLUDED */
